...
output_path = '../data/isic2018-rgb-attributes/'
...
for family in sorted(file_name_arr):
	...
	traditional = misc.imread(traditional_path+family+'.png')
	traditional[stacked_img == 2] = 255
	traditional[stacked_img < 2] = 0
	misc.toimage(traditional, cmin=0, cmax=255).save(output_path+family+'.png')
